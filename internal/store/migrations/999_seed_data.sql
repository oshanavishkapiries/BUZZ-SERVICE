...
Best regards,
The {{app_name}} Team',
        ARRAY['name', 'app_name', 'verification_link'],
        true,
        NOW(),
        NOW()
    ),
    (
        gen_random_uuid(),
        'Password Reset',
        'Password reset email with temporary code',
        ARRAY['email'],
        'Reset Your Password',
        'Hi {{name}},
...
Best regards,
The {{app_name}} Team',
        ARRAY['name', 'reset_code', 'expiry_minutes', 'app_name'],
        true,
        NOW(),
        NOW()
    ),
...
Best regards,
The {{app_name}} Team',
        ARRAY['customer_name', 'order_id', 'order_total', 'delivery_date', 'app_name'],
        true,
        NOW(),
        NOW()
    ),
    (
        ...
        'Generic push notification for alerts',
        ARRAY['push', 'in_app'],
        '{{title}}',
        '{{message}}',
        ARRAY['title', 'message'],
    ...
    (
        gen_random_uuid(),
        'Promotional SMS',
        'Promotional SMS for marketing campaigns',
        ARRAY['sms'],
        NULL,
        '{{promotion_text}}
...
Reply STOP to unsubscribe.',
        ARRAY['promotion_text', 'promo_code', 'expiry_date'],
        true,
        NOW(),
        NOW()
    );
...
VALUES
    ...
    (
        ...
        'Full access API key for production',
        '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy',
        'bz_live_',
        'production',
