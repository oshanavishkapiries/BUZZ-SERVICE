...
INSERT INTO templates (id, application_id, name, description, channels, subject, body, variables, is_active, created_at, updated_at)
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Welcome Email', 'Welcome email sent to new users',
...
INSERT INTO templates (id, application_id, name, description, channels, subject, body, variables, is_active, created_at, updated_at)
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Password Reset', 'Password reset email with temporary code',
...
INSERT INTO templates (id, application_id, name, description, channels, subject, body, variables, is_active, created_at, updated_at)
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'OTP Verification', 'One-time password for verification',
...
INSERT INTO templates (id, application_id, name, description, channels, subject, body, variables, is_active, created_at, updated_at)
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Order Confirmation', 'Order confirmation with details',
...
INSERT INTO templates (id, application_id, name, description, channels, subject, body, variables, is_active, created_at, updated_at)
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Push Notification Alert', 'Generic push notification for alerts',
...
INSERT INTO templates (id, application_id, name, description, channels, subject, body, variables, is_active, created_at, updated_at)
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Promotional SMS', 'Promotional SMS for marketing campaigns',
...
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Test API Key - Development', 'API key for development and testing with full access',
...
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Production API Key - Full Access', 'Full access API key for production environment',
...
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Monitoring API Key - Read Only', 'Read-only access for monitoring and statistics',
...
SELECT gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Sender API Key - Limited', 'Limited access for sending notifications only',
